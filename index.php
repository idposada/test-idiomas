<?php include('header.php') ?>
    <main>
      <section class="bg-morado">
        ...
        <div class="txt-intro animate__animated animate__fadeIn bienvenida">
          CENTRO DE LENGUAS
        </div>
        <div class="abajo">
          ...
          <a href="registro.php" class="waves-effect waves-light btn-large btn-blanco animate__animated animate__fadeInUp">Descubre tu nivel</a>
          </div>
        </div>

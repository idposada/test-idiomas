      ...
      <div class="formulario">
        <form class="" action="index.html" method="post">
          ...
          <div class="left boton">
            ...
            <span class="txt-terminos">Autorizo a la Universidad El Bosque para el envío de información. Términos y condiciones</span>
          </div>
          <div class="center boton">
            <input type="submit" name="" value="Descubre tu nivel" class="waves-effect waves-light btn-large btn-blanco center">
          </div>
